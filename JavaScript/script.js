...
$(function() {
	$('.buttonBuy').click(function() {
		...
		Swal.fire({
			...
			icon: 'success',
			html:
				'<p class="text-center text-success">Aún hay mucho por comprar</p> <br><i class="far fa-laugh-wink fa-2x text-light mt-3"></i>',
...
$(function() {
	$('#buyButton').click(function() {
		let timerInterval;
		Swal.fire({
			title: '<p class="text-light">Compra realizada con <span class="text-warning">éxito.</span><p>',
			icon: 'success',
			html:
				'<p class="text-center text-primary">Productos Blizzardi. Lo mismo pero más barato.</p>',
			background: 'rgb(29, 29, 29)',
			timer: 6000,
			timerProgressBar: true,
			didOpen: () => {
